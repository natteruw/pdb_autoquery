...
<description>Finds PDB entries based on symmetry: Protein Symmetry is D2 and RMSD is between the default min 0.0 and the default max 7.0</description>
...
<description>Sequence Length is between 75 and 300 </description>
...
<v_sequence.chainLength.max>300</v_sequence.chainLength.max>
</orgPdbQuery>
