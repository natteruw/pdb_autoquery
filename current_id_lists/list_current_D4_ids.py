...
<description>Finds PDB entries based on symmetry: Protein Symmetry is D4 and RMSD is between the default min 0.0 and the default max 7.0</description>
...
if result:
	    ...
	    print result
            temp=open('./updated_temp_id_lists/tempD4', 'w+')
	    temp.write(result)
else:
